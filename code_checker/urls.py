...
from problems.views import group_problems,problem,submit,problem_submissions,user_submissions,show_testcases,rankings
urlpatterns = [
    ...
    url(r'^rankings/(?P<group_id>\w+)/$',rankings ),    
